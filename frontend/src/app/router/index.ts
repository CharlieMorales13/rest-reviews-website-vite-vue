...
const routes = [
  ...
  },
  {
    ...
    component: () =>
      import("@/pages/forgot-password/ui/ForgotPasswordPage.vue"),
    meta: { guest: true },
  },
  {
    path: "/reset-password",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import("@/pages/manager-establishment/ui/ManagerEstablishmentPage.vue"),
        meta: { roles: ["manager", "admin"] },
      },
      {
        path: "admin",
      ...
      },
      {
        ...
        name: "establishments",
        component: () =>
          import("@/pages/establishments/ui/EstablishmentsPage.vue"),
      },
      {
        path: "establishments/:slug",
        name: "establishment-details",
        component: () =>
          import("@/pages/establishments/ui/EstablishmentDetailsPage.vue"),
      },
      {
        path: "review/create/:slug",
        name: "create-review",
        component: () =>
          import("@/pages/create-review/ui/CreateReviewPage.vue"),
        meta: { roles: ["student"] },
        props: true,
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import("@/pages/manager-reviews/ui/ManagerReviewsPage.vue"),
        meta: { roles: ["manager", "admin"] },
      },
    ],
  },
