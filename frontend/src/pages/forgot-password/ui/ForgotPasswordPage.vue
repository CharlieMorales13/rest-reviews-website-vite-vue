    ...
    <div class="relative z-10 w-full max-w-md p-6 animate-fade-in">
      <div class="bg-white/5 backdrop-blur-2xl border border-white/20 rounded-[32px] p-8 md:p-12 shadow-2xl">
        ...
        <div class="text-center mb-10">
          ...
          <h1 class="text-3xl font-bold tracking-tight text-white mb-2">¿Olvidaste tu contraseña?</h1>
          <p class="text-white/60 text-sm">Te enviaremos un enlace para restablecerla</p>
        </div>
        ...
        <div v-if="sent" class="text-center space-y-6">
          <div class="p-6 bg-green-500/10 border border-green-500/20 rounded-2xl">
            ...
            <p class="text-white/60 text-sm">
              ...
              El enlace expira en <strong class="text-white/80">1 hora</strong>.
            </p>
          </div>
          <router-link to="/login" class="block text-anahuac-orange text-sm font-medium hover:underline">
        ...
        <form v-else @submit.prevent="handleSubmit" class="space-y-6">
          <div class="space-y-2">
            <label class="block text-xs font-medium text-white/50 ml-1 uppercase tracking-wider">Correo electrónico</label>
          ...
          <div class="text-center pt-2">
            <router-link to="/login" class="text-white/40 text-sm hover:text-white/70 transition-colors">
              Volver al inicio de sesión
            </router-link>
          </div>
        </form>
